...
axs[4].format(coast=True, latlines=10,coastcolor='black',land=True,landcolor='white',title='',boundinglat=-50)
axs[5].format(coast=True, latlines=10,coastcolor='black',land=True,landcolor='white',title='',boundinglat=-50)
axs[6].format(coast=True, latlines=10,coastcolor='black',land=True,landcolor='white',title='',boundinglat=-50)
